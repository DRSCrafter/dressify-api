...
---------------------------------
insert into user values (default, "امیر محمد", "محمدزاده", "amirMohammad.mohammadzadeh@gmail.com", "1234", curdate());
...
insert into user values (default, "معصومه", "کشاورز", "masoume.keshavarz@gmail.com", "masoume234*", curdate());
...
insert into user values (default, "سینا", "زارعی", "sina34z@gmail.com", "qweert34!#", curdate());
insert into useraddress values ("Tehran", "Enghelab", 3);
insert into userphonenumbers values("09158730187",3);

insert into user values (default, "گلی", "شفیعی", "goligoli1376@gmail.com", "zxjsjdfAA12", curdate());
...
insert into user values (default, "علی", "ظهوریان", "ali2128@gmail.com", "324324Ak", curdate());
insert into useraddress values ("Mashhad", "Sajjad Blv",5);
insert into userphonenumbers values("09127629843",5);

insert into user values (default, "سحر", "حسینی", "saharHosseini@gmail.com", "reZZZZaYu", curdate());
...
insert into user values (default, "غلام", "امینی", "gholam432gmail.com", "qwertGHolam222", curdate());
insert into useraddress values ("Yazd", "Imam Ali St",7);
insert into userphonenumbers values("09037184378",7);

insert into user values (default, "مژده", "صادقی", "Mozhde_Sadeghi@gmail.com", "mozhi34322__3", curdate());
insert into useraddress values ("Mashhad", "دانشجو", 8);
insert into userphonenumbers values("09128732984",8);

insert into user values (default, "شهریار", "زارع پور", "shahriyaaaar1379@gmail.com", "92672187423AAA", curdate());
insert into useraddress values ("Tehran", "Fereshteh", 9);
insert into userphonenumbers values("09036719810",9);

insert into user values (default, "سارا", "نقی زاده", "SaraNaghizade12@gmail.com", "98sara13808080", curdate());
insert into useraddress values ("Mashhad", "Palestine", 10);
insert into userphonenumbers values("09035187610",10);

insert into user values (default, "آرزو", "محمدی", "Arezooooo_m75@gmail.com", "a1298***6", curdate());

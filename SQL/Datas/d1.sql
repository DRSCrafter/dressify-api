...
insert into provideraddresses values ("ایران","تهران","خیابان پاسداران", 4); 
insert into provideraddresses values ("ایران","تهران","خیابان مطهری", 4);

insert into provider values (default, "تندرست");
insert into provideraddresses values ("ایران","مشهد","خیابان راهنمایی", 5); 
insert into provideraddresses values ("ایران","مشهد","خیابان اندرزگو", 5);

insert into provider values (default, "چرم مشهد");
insert into provideraddresses values ("ایران","مشهد","احمدآباد", 6); 
insert into provideraddresses values ("ایران","مشهد","وکیل آباد", 6);
insert into provideraddresses values ("ایران","مشهد","بولوار سجاد", 6);

----------------------------------------------------------

insert into product values(default, "شلوار جین آبی", 0, "M", "Polyester", 15, 1);
insert into productcolors values(1, 1);
insert into provider_has_product values(default,1, 1);
...
insert into provider_has_product values(default,4,2);
...
insert into provider_has_product values(default,2,3);
...
insert into provider_has_product values(default,6,4);
insert into pricehistory values(default, 3100000,"2023-01-05", 4,4);
insert into provider_has_product values(default,3,4);
...
insert into provider_has_product values(default,4,5);
...
insert into provider_has_product values(default,5,6);
insert into pricehistory values(default, 1500000,"2023-01-05", 6,7);
insert into provider_has_product values(default,2,6);
insert into pricehistory values(default, 1600000,"2023-01-05", 6,8);
insert into provider_has_product values(default,3,6);
insert into pricehistory values(default, 1750000,"2023-01-05", 6,9);

insert into product values(default, "بافت یقه هفت آستین بلند",1,"XL", 'Silk', 7, 3);
insert into productcolors values(7, 5);
insert into provider_has_product values(default,2,7);
insert into pricehistory values(default, 780000,"2023-01-05", 7,10);
insert into provider_has_product values(default,3,7);
insert into pricehistory values(default, 750000,"2023-01-05", 7,11);
insert into provider_has_product values(default,1,7);
insert into pricehistory values(default, 680000,"2023-01-05", 7,12);
...
insert into payment values(9300000.0, "2023-01-07", 1);
...
insert into payment values(6100000.0, "2023-01-09", 2);
...
insert into payment values(1680000.0, "2023-01-8", 3);
